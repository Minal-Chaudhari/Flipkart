...
public class LoginPageTests extends BaseClass {
    ...
    @Test(priority = 3,description = "LGN_002: Verify the presence of the email/mobile number field")
    ...
    @Test(priority = 5,description = "LGN_007: Verify redirection to 'Terms of Use' page")
    ...
    @Test(priority = 5,description = "LGN_012: Verify redirection to 'Privacy Policy' page")
    ...
    @Test(priority = 3,description = "LGN_008: Validate error message for invalid mobile number input")
    ...
    public void enterInvalidEmailID() {
        ...
        //Thread.sleep(5000);
        login.clickButton(LoginPageLocators.newUserPageExistingUserButton);
    ...
    @Test(priority = 4,description = "LGN_005: Verify redirection to 'Create Account' page")
